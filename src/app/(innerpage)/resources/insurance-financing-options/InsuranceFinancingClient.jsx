...
import { FaShieldAlt, FaCreditCard, FaHandshake, FaPhoneAlt, FaEnvelope, FaCheckCircle } from 'react-icons/fa';
...
const InsuranceFinancingClient = () => {
  return (
    <div>
      <Section
...
export default InsuranceFinancingClient;
