...
export async function generateMetadata() {
  return getSeoMetadata({
    pageUrl: '/international-patients/international-pricing',
  ...
  return (
    <div>
      <Section
        ...
        backgroundImage="/assets/img/InternationalPricing.webp"
      >
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-12 cs_service_page_content">
              <IVFContentSection data={pricingContentData} benefitImages={serviceData.benefitImages} accentHeadingStyle />
            </div>
          </div>
        </div>
      </Section>
