...
export async function generateMetadata() {
  return getSeoMetadata({
    pageUrl: '/international-patients/travel-support',
    hierarchyCandidates: [['International Patients'], []],
  });
}

const headingData = {
  uspTitle: 'Travel <span class="cs_accent_color">Support </span>',
};
  ...
  return (
    <div>
      <Section
        ...
        backgroundImage="/assets/img/TravelSupport.webp"
      >
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-12 cs_service_page_content">
              <IVFContentSection data={travelContentData} benefitImages={serviceData.benefitImages} accentHeadingStyle />
            </div>
          </div>
        </div>
      </Section>
