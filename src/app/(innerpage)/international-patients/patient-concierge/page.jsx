...
export async function generateMetadata() {
  return getSeoMetadata({
    pageUrl: '/international-patients/patient-concierge',
  ...
  return (
    <div>
      <Section
        ...
        backgroundImage="/assets/img/PatientConcierge.webp"
      >
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-12 cs_service_page_content">
              <IVFContentSection data={conciergeContentData} benefitImages={serviceData.benefitImages} accentHeadingStyle />
            </div>
          </div>
        </div>
      </Section>
