...
export async function generateMetadata() {
  return getSeoMetadata({
    pageUrl: '/training-academy/andrology-technician-training-program',
  ...
  return (
    <div>
      <Section
        ...
        backgroundImage="/assets/img/AndrologyTechnicianTrainingProgram.webp"
      >
        <PageHeading data={headingData} />
      </Section>

      <TrainingProgramPageContent
        contentData={andrologyContentData}
        defaultProgram="andrology-technician"
      />
    </div>
  );
};
