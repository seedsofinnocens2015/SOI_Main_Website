...
export async function generateMetadata() {
  return getSeoMetadata({
    pageUrl: '/training-academy/gynecologic-surgical-training-program',
  ...
  return (
    <div>
      <Section
        ...
        backgroundImage="/assets/img/GynecologicSurgicalTrainingProgram.webp"
      >
        <PageHeading data={headingData} />
      </Section>

      <TrainingProgramPageContent
        contentData={gynecologicSurgicalContentData}
        defaultProgram="gynecologic-surgical"
      />
    </div>
  );
};
