...
const serviceData = {
  serviceHeading: '',
  services: [],
  mainImage: '/assets/img/recent_post2webp',
  serviceDetails: [],
  footerText: '',
  additionalImages: '/assets/img/recent_post2webp',
  iconBoxes: [],
  subtitle: '',
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 cs_service_page_content">
              <IVFContentSection data={surrogacyContentData} benefitImages={serviceData.benefitImages} accentHeadingStyle />
            </div>
          </div>
        </div>
      </Section>
