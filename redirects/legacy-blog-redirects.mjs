...
const legacyBlogRedirects = [
  ...
  },
  {
    ...
    destination: '/blogs/painful-sex-and-infertility/',
    permanent: true,
  },
  ...
  { source: '/ivf-treatment-in-gurgaon/', destination: blogListingDestination, permanent: true },
  {
    ...
    destination: '/blogs/ivf-treatment-in-kochi/',
    permanent: true,
  },
  ...
  },
  {
    ...
    destination: '/blogs/hormonal-imbalances-impact-on-fertility/',
    permanent: true,
  },
  {
    source: '/failed-ivf-a-dead-end/',
    destination: '/blogs/failed-ivf-a-dead-end/',
    permanent: true,
  },
  {
    source: '/male-fertility-preservation-sperm-freezing/',
    destination: '/blogs/male-fertility-preservation-sperm-freezing/',
    permanent: true,
  },
  {
    source: '/male-fertility-test-when-and-why-you-should-consider-it/',
    destination: '/blogs/male-fertility-test-when-and-why-you-should-consider-it/',
    permanent: true,
  },
  ...
  },
  {
    ...
    destination: '/blogs/ejaculation-disorders-causes-types-and-treatment/',
    permanent: true,
  },
  {
    source: '/low-sperm-count-here-is-what-you-need-to-know/',
    destination: '/blogs/low-sperm-count-here-is-what-you-need-to-know/',
    permanent: true,
  },
  {
    source: '/how-to-improve-sperm-health/',
    destination: '/blogs/how-to-improve-sperm-health/',
    permanent: true,
  },
  { source: '/follicular-monitoring/', destination: blogListingDestination, permanent: true },
  {
    ...
    destination: '/blogs/male-infertility-causes-symptoms-solutions/',
    permanent: true,
  },
  {
    source: '/male-factor-infertility-causes-treatment/',
    destination: '/blogs/male-factor-infertility-causes-treatment/',
    permanent: true,
  },
  {
    source: '/embryo-quality-most-for-ivf-success/',
    destination: '/blogs/embryo-quality-most-for-ivf-success/',
    permanent: true,
  },
  {
    source: '/can-ivf-help-with-female-infertility-caused-by-pcos/',
    destination: '/blogs/can-ivf-help-with-female-infertility-caused-by-pcos/',
    permanent: true,
  },
  {
    source: '/age-and-fertility-explained-key-facts-you-must-know/',
    destination: '/blogs/age-and-fertility-explained-key-facts-you-must-know/',
    permanent: true,
  },
  {
    source: '/embryo-transfer-signs-symptoms/',
    destination: '/blogs/embryo-transfer-signs-symptoms/',
    permanent: true,
  },
  {
    source: '/boosting-fertility-natural-ways-to-increase-amh-levels/',
    destination: '/blogs/natural-ways-to-increase-amh-levels/',
    permanent: true,
  },
  {
    source: '/nisantaanta-ka-hal-ab-mumkin-hai/',
    destination: '/blogs/nisantaanta-ka-hal-ab-mumkin-hai/',
    permanent: true,
  },
  {
    source: '/achhi-jeevan-shailee-se-behtar-ho-sakti-hai-aapki-fertility/',
    destination: '/blogs/achhi-jeevan-shailee-se-behtar-ho-sakti-hai-aapki-fertility/',
    permanent: true,
  },
  {
    source: '/ivf-se-maa-banne-ka-safar-umeed-aur-haqeeqat/',
    destination: '/blogs/ivf-se-maa-banne-ka-safar-umeed-aur-haqeeqat/',
    permanent: true,
  },
  {
    source: '/bulky-uterus-symptoms-causes-treatment/',
    destination: '/blogs/bulky-uterus-symptoms-causes-treatment/',
    permanent: true,
  },
  {
    source: '/pcos-ivf-and-the-menstrual-cycle/',
    destination: '/blogs/pcos-ivf-and-the-menstrual-cycle/',
    permanent: true,
  },
  {
    source: '/hormonal-health-and-ivf/',
    destination: '/blogs/hormonal-health-and-ivf/',
    permanent: true,
  },
  {
    source: '/key-factors-that-influence-ivf-success/',
    destination: '/blogs/key-factors-that-influence-ivf-success/',
    permanent: true,
  },
  {
    source: '/how-diet-exercise-affect-pregnancy/',
    destination: '/blogs/how-diet-exercise-affect-pregnancy/',
    permanent: true,
  },
  {
    source: '/prp-therapy-for-ivf-success/',
    destination: '/blogs/prp-therapy-for-ivf-success/',
    permanent: true,
  },
  {
    source: '/getting-pregnant-naturally/',
    destination: '/blogs/getting-pregnant-naturally/',
    permanent: true,
  },
  {
    source: '/cervical-health-ivf-success/',
    destination: '/blogs/cervical-health-ivf-success/',
    permanent: true,
  },
  {
    source: '/why-does-ivf-fail/',
    destination: '/blogs/why-does-ivf-fail/',
    permanent: true,
  },
  {
    source: '/diabetes-in-men-and-women/',
    destination: '/blogs/diabetes-in-men-and-women/',
    permanent: true,
  },
  {
    source: '/hypertension-impacts-pregnancy-and-fertility/',
    destination: '/blogs/hypertension-impacts-pregnancy-and-fertility/',
    permanent: true,
  },
  { source: '/how-does-the-thyroid-affect-fertility/', destination: blogListingDestination, permanent: true },
  {
    source: '/pgta-ivf-journey/',
    destination: '/blogs/pgta-ivf-journey/',
    permanent: true,
  },
  {
    source: '/online-prenatal-yoga/',
    destination: '/blogs/online-prenatal-yoga/',
    permanent: true,
  },
  {
    source: '/male-infertility-symptoms-causes-treatment/',
    destination: '/blogs/male-infertility-symptoms-causes-treatment/',
    permanent: true,
  },
  {
    source: '/how-lifestyle-affects-fertility-what-you-can/',
    destination: '/blogs/how-lifestyle-affects-fertility-what-you-can/',
    permanent: true,
  },
  {
    source: '/ivf-journey-process-essential-tips-dos-donts/',
    destination: '/blogs/ivf-journey-process-essential-tips-dos-donts/',
    permanent: true,
  },
  {
    source: '/choosing-the-right-ivf-specialist/',
    destination: '/blogs/choosing-the-right-ivf-specialist/',
    permanent: true,
  },
  {
    source: '/affordable-ivf-cost/',
    destination: '/blogs/affordable-ivf-cost/',
    permanent: true,
  },
  {
    source: '/advancing-parenthood-at-premier-icsi-centres/',
    destination: '/blogs/advancing-parenthood-at-premier-icsi-centres/',
    permanent: true,
  },
  {
    source: '/health-in-fertility-treatments/',
    destination: '/blogs/health-in-fertility-treatments/',
    permanent: true,
  },
  {
    source: '/understanding-the-impact-of-icsi-on-art-success/',
    destination: '/blogs/understanding-the-impact-of-icsi-on-art-success/',
    permanent: true,
  },
  {
    source: '/miscarriage-journey-from-coping-healing/',
    destination: '/blogs/miscarriage-journey-from-coping-healing/',
    permanent: true,
  },
  {
    source: '/how-lifestyle-affects-fertility-what-you-can-do-to-improve-your-chances/',
    destination: '/blogs/how-lifestyle-affects-fertility-what-you-can-do-to-improve-your-chances/',
    permanent: true,
  },
  {
    source: '/pcos-symptoms-treatment-and-fertility/',
    destination: '/blogs/pcos-symptoms-treatment-and-fertility/',
    permanent: true,
  },
  {
    source: '/shighrapatan-ke-upay-lakshan-aur-ilaaj/',
    destination: '/blogs/shighrapatan-ke-upay-lakshan-aur-ilaaj/',
    permanent: true,
  },
  {
    source: '/kam-shukranu-sankhya-kaaran-lakshan-aur-upchaar/',
    destination: '/blogs/kam-shukranu-sankhya-kaaran-lakshan-aur-upchaar/',
    permanent: true,
  },
  { source: '/so-you-have-completed-your-covid-vaccination/', destination: blogListingDestination, permanent: true },
  {
    ...
    destination: '/blogs/what-is-prp-treatment-in-ivf/',
    permanent: true,
  },
  {
    source: '/understanding-the-basics-of-fertility/',
    destination: '/blogs/understanding-the-basics-of-fertility/',
    permanent: true,
  },
  {
    source: '/can-i-pill-cause-infertility-in-women/',
    destination: '/blogs/can-i-pill-cause-infertility-in-women/',
    permanent: true,
  },
  {
    source: '/poor-egg-quality-and-fertility/',
    destination: '/blogs/poor-egg-quality-and-fertility/',
    permanent: true,
  },
  {
    source: '/thyroid-impacts-pregnancy-and-ivf-success/',
    destination: '/blogs/thyroid-impacts-pregnancy-and-ivf-success/',
    permanent: true,
  },
];
